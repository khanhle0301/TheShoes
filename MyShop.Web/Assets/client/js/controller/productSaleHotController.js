...
var productSaleHotController = {
    init: function () {
        productSaleHotController.loadData();
        productSaleHotController.registerEvent();
    },
    registerEvent: function () {
        $('.btn-popup').off('click').on('click', function (e) {
            ...
            productSaleHotController.loadColor(productId);
            productSaleHotController.loadSize(productId);
            productSaleHotController.loadProductName(productId);
        });

        $('#sortControl').off('click').on('click', function () {
            productSaleHotController.loadData(true);
        });
    ...
    loadData: function (changePageSize) {
        ...
        $.ajax({
            url: '/Product/LoadDataSaleHotProduct',
            type: 'GET',
            data: {
                sort: sort,
                price: price,
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    if (html == '') {
                        ...
                        productSaleHotController.paging(response.total, function () {
                            productSaleHotController.loadData();
                        }, changePageSize);
                    }
                    productSaleHotController.registerEvent();
