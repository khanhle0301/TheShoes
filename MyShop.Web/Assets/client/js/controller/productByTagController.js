...
var productByTagController = {
    init: function () {
        productByTagController.loadData();
        productByTagController.registerEvent();
    },
    registerEvent: function () {
        $('.btn-popup').off('click').on('click', function (e) {
            ...
            productByTagController.loadColor(productId);
            productByTagController.loadSize(productId);
            productByTagController.loadProductName(productId);
        });

        $('#sortControl').off('click').on('click', function () {
            productByTagController.loadData(true);
        });
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    if (html == '') {
                        ...
                        productByTagController.paging(response.total, function () {
                            productByTagController.loadData();
                        }, changePageSize);
                    }
                    productByTagController.registerEvent();
