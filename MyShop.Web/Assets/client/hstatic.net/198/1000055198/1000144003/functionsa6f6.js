	...
	var lazyLoad = function() {
		...
		if( lazyLoadEl.length > 0 ) {
			lazyLoadEl.each( function(){
				...
				element.attr( 'src', 'http://hstatic.net/198/1000055198/1000144003/blank.svg?v=311' ).css({ 'background': 'url(http://hstatic.net/198/1000055198/1000144003/preloader.gif?v=311) no-repeat center center #FFF' });
